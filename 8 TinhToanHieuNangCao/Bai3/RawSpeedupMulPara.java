...
public class RawSpeedupMulPara extends Thread {
	private int n;
	private int st;
	private int en;
	private int[][] result;
	...
	public RawSpeedupMulPara(int n, int st, int en, int[][] result, int[][] matrix1, int[][] matrix2) {
		this.result = result;
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(cpu=1;cpu<=20;cpu++){
			RawSpeedupMulPara t[] = new RawSpeedupMulPara[cpu];
			...
			for (int i = 0; i < cpu; i++) {
				...
				t[i] = new RawSpeedupMulPara(n, startIndex, endIndex, result, first, second);
				startIndex = endIndex;
			}
