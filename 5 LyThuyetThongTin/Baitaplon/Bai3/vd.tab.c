...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_CONSTANT = 4,                 /* T_CONSTANT  */
  ...
  YYSYMBOL_DeclarationList = 20,           /* DeclarationList  */
  YYSYMBOL_Declaration = 21,               /* Declaration  */
  YYSYMBOL_StatementList = 22,             /* StatementList  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "T_PRINT",
  "T_CONSTANT", "T_IDENTIFIER", "'+'", "'-'", "'*'", "'/'", "UMINUS",
  "'{'", "'}'", "';'", "'('", "')'", "'='", "$accept", "Program", "Block",
  "DeclarationList", "Declaration", "StatementList", "Statement",
...
{
      14,     3,    12,   -15,   -15,     0,    16,   -15,    13,    19,
      24,    26,     3,    -3,    -3,   -15,     0,   -15,   -15,   -15,
      -3,    -3,    11,    25,   -15,   -15,    15,    -3,    -3,    -3,
      -3,   -15,   -15,     1,     1,   -15,   -15
};
...
{
       0,     0,     0,     2,     6,     0,     4,     1,     0,     0,
       0,     7,     0,     0,     0,     3,     0,     5,    17,    18,
       0,     0,     0,    10,     8,    15,     0,     0,     0,     0,
       0,     9,    16,    11,    12,    13,    14
};
...
{
      23,    18,    19,     8,    20,     9,    25,    26,     4,    29,
      30,    21,     7,    33,    34,    35,    36,    27,    28,    29,
      30,    27,    28,    29,    30,     1,    31,    13,     0,    12,
      32,    27,    28,    29,    30,    14,    15,    24,     0,    16,
      17
};

static const yytype_int8 yycheck[] =
{
      14,     4,     5,     3,     7,     5,    20,    21,     5,     8,
       9,    14,     0,    27,    28,    29,    30,     6,     7,     8,
       9,     6,     7,     8,     9,    11,    15,    14,    -1,    13,
      15,     6,     7,     8,     9,    16,    12,    16,    -1,    13,
      12
};
...
{
       0,    11,    18,    19,     5,    20,    21,     0,     3,     5,
      22,    23,    13,    14,    16,    12,    13,    20,     4,     5,
       7,    14,    24,    24,    22,    24,    24,     6,     7,     8,
       9,    15,    15,    24,    24,    24,    24
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* Declaration: T_IDENTIFIER  */
#line 109 "vd.y"
                          { executeAssignment(yyvsp[0], 0); }
#line 1186 "vd.tab.c"
    break;

  case 9: /* Statement: T_PRINT '(' Expression ')'  */
#line 114 "vd.y"
                                        { executePrint(yyvsp[-1]); }
#line 1192 "vd.tab.c"
    break;

  case 10: /* Statement: T_IDENTIFIER '=' Expression  */
#line 115 "vd.y"
...
#line 117 "vd.y"
                                       { executeBinaryOperation("ADD"); }
#line 1204 "vd.tab.c"
    break;

  case 12: /* Expression: Expression '-' Expression  */
#line 118 "vd.y"
                                       { executeBinaryOperation("SUB"); }
#line 1210 "vd.tab.c"
    break;

  case 13: /* Expression: Expression '*' Expression  */
#line 119 "vd.y"
                                       { executeBinaryOperation("MUL"); }
#line 1216 "vd.tab.c"
    break;

  case 14: /* Expression: Expression '/' Expression  */
#line 120 "vd.y"
                                       { executeBinaryOperation("DIV"); }
#line 1222 "vd.tab.c"
    break;

  case 15: /* Expression: '-' Expression  */
#line 121 "vd.y"
                                         { executeUnaryOperation("UMINUS"); }
#line 1228 "vd.tab.c"
    break;

  case 17: /* Expression: T_CONSTANT  */
#line 123 "vd.y"
                        { executePush(yyvsp[0]); }
#line 1234 "vd.tab.c"
    break;

  case 18: /* Expression: T_IDENTIFIER  */
#line 124 "vd.y"
                          { yyval = evaluateVariable(yyvsp[0]); }
#line 1240 "vd.tab.c"
    break;
